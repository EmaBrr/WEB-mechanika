...
//Skaičiuojam, kiek kartų buvom puslapy
...
//KLAUSIMAS AR TAM IF'E YRA NAME, tas name = kažkas? ar name = name?
...
if (isset($_POST['name']) && !isset($_POST['id'])) {
    ...
    $_SESSION['id']++;
    header("location:./antrapaskaita.php");
    die;
};
...
<!-- <form action="" method="post"> -->
    ...
    <button type="submit">count me</button>  -->
                    <!-- KODĖL NEGALĖJOM KINTAMOJO DĖT ANT MYGTUKO? KAD NEREIKĖTŲ TO HIDDEN INPUTO? -->
<!-- </form> -->
